...
; 0000 0040 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=Out
; 0000 0041 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(1)
	OUT  0x1A,R30
; 0000 0042 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=0
...
; 0000 005C // Timer Period: 1 ms
; 0000 005D TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (0<<CS02) | (1<<CS01) | (1<<CS00);
	LDI  R30,LOW(3)
	OUT  0x33,R30
; 0000 005E TCNT0=0x83;
	LDI  R30,LOW(131)
	OUT  0x32,R30
; 0000 005F OCR0=0x00;
	LDI  R30,LOW(0)
...
_0x8:
; 0000 00A9       {
; 0000 00AA       if (PINC.0 == 1)
	SBIS 0x13,0
	RJMP _0xB
; 0000 00AB       {
; 0000 00AC       while (PINC.0 == 1){}
_0xC:
	SBIC 0x13,0
	RJMP _0xC
; 0000 00AD       PORTA.0 = 1;
