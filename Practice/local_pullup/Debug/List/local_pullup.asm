...
; 0000 0022 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=Out Bit0=In
; 0000 0023 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (1<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(2)
	OUT  0x1A,R30
; 0000 0024 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=0 Bit0=P
; 0000 0025 PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (0<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(1)
	OUT  0x1B,R30
; 0000 0026 
...
; 0000 0031 PORTC=(0<<PORTC7) | (0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (1<<PORTC0);
	LDI  R30,LOW(1)
	OUT  0x15,R30
; 0000 0032 
...
; 0000 0089       if(PINC.0 == 1){
	SBIS 0x13,0
	RJMP _0x6
; 0000 008A       PORTA.2 = 1;
	SBI  0x1B,2
; 0000 008B       }
; 0000 008C       else{PORTA.2 = 0;}
	RJMP _0x9
_0x6:
	CBI  0x1B,2
_0x9:
