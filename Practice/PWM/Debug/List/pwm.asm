...
; 0000 0029 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(8)
	OUT  0x17,R30
; 0000 002A // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=T Bit1=T Bit0=T
...
; 0000 003E // Timer Period: 0.256 ms
; 0000 003F // Output Pulse(s):
; 0000 0040 // OC0 Period: 0.256 ms Width: 0.1536 ms
; 0000 0041 TCCR0=(1<<WGM00) | (1<<COM01) | (0<<COM00) | (1<<WGM01) | (0<<CS02) | (1<<CS01) | (0<<CS00);
	LDI  R30,LOW(106)
	OUT  0x33,R30
...
; 0000 008C       if(PINC.0 == 1 && OCR0 < 0xF0){
	SBIS 0x13,0
	RJMP _0x7
	IN   R30,0x3C
	CPI  R30,LOW(0xF0)
...
_0x7:
	RJMP _0x6
_0x8:
; 0000 008D       while(PINC.0 == 1){};
_0x9:
	SBIC 0x13,0
	RJMP _0x9
; 0000 008E       OCR0 = OCR0 + 0x09;
	IN   R30,0x3C
	SUBI R30,-LOW(9)
	OUT  0x3C,R30
; 0000 008F 
; 0000 0090 
; 0000 0091       }
; 0000 0092       if(PINC.7 == 1 && OCR0 > 0xA0 ){
_0x6:
	SBIS 0x13,7
	RJMP _0xD
	IN   R30,0x3C
...
_0xD:
	RJMP _0xC
_0xE:
; 0000 0093       while(PINC.7 == 1){};
_0xF:
	SBIC 0x13,7
	RJMP _0xF
; 0000 0094       OCR0 = OCR0 - 0x09;
	IN   R30,0x3C
	SUBI R30,LOW(9)
	OUT  0x3C,R30
; 0000 0095 
