...
;http://www.hpinfotech.com
;
;Project : ALL-BUTTON-PUSH-ON-LED
;Version :
;Date    : 24/04/2024
;Author  :
;Company :
...
; 0000 0020 bool flag_0 = false;
; 0000 0021 bool flag_1 = false;
; 0000 0022 bool flag_2 = false;
; 0000 0023 bool flag_3 = false;
...
; 0000 0032 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=Out
; 0000 0033 DDRC = (0 << DDC7) | (0 << DDC6) | (0 << DDC5) | (0 << DDC4) | (0 << DDC3) | (0 << DDC2) | (0 << DDC1) | (1 << DDC0);
	LDI  R30,LOW(1)
	OUT  0x14,R30
; 0000 0034 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=0
...
; 0000 003B PORTD = (0 << PORTD7) | (0 << PORTD6) | (0 << PORTD5) | (0 << PORTD4) | (0 << PORTD3) | (0 << PORTD2) | (0 << PORTD1) |  ...
	OUT  0x12,R30
; 0000 003C 
...
; 0000 0068 TIMSK = (0 << OCIE2) | (0 << TOIE2) | (0 << TICIE1) | (0 << OCIE1A) | (0 << OCIE1B) | (0 << TOIE1) | (0 << OCIE0) | (0 < ...
	OUT  0x39,R30
; 0000 0069 
...
; 0000 0080 ADCSRA = (0 << ADEN) | (0 << ADSC) | (0 << ADATE) | (0 << ADIF) | (0 << ADIE) | (0 << ADPS2) | (0 << ADPS1) | (0 << ADPS ...
	OUT  0x6,R30
; 0000 0081 
...
; 0000 008C {
; 0000 008D 
; 0000 008E     if (PINA.0 == 1)
	SBIC 0x19,0
; 0000 008F     {
; 0000 0090           flag_0 = true;
	LDI  R17,LOW(1)
; 0000 0091     }
; 0000 0092     if (PINA.1 == 1)
	SBIC 0x19,1
; 0000 0093     {
; 0000 0094           flag_1 = true;
	LDI  R16,LOW(1)
; 0000 0095     }
; 0000 0096     if (PINA.2 == 1)
	SBIC 0x19,2
; 0000 0097     {
; 0000 0098           flag_2 = true;
	LDI  R19,LOW(1)
; 0000 0099     }
; 0000 009A     if (PINA.3 == 1)
	SBIC 0x19,3
; 0000 009B     {
; 0000 009C           flag_3 = true;
	LDI  R18,LOW(1)
; 0000 009D     }
; 0000 009E     if ((flag_0 && flag_1 && flag_2 && flag_3))
	CPI  R17,0
	BREQ _0xB
	CPI  R16,0
	BREQ _0xB
...
; 0000 00A0           PORTC.0 = 1;
	SBI  0x15,0
; 0000 00A1           delay_ms(3000);
	LDI  R26,LOW(3000)
	LDI  R27,HIGH(3000)
	CALL _delay_ms
; 0000 00A2           PORTC.0 = 0;
	CBI  0x15,0
; 0000 00A3           flag_0 = false;
	LDI  R17,LOW(0)
; 0000 00A4           flag_1 = false;
	LDI  R16,LOW(0)
; 0000 00A5           flag_2 = false;
	LDI  R19,LOW(0)
; 0000 00A6           flag_3 = false;
	LDI  R18,LOW(0)
; 0000 00A7     }
; 0000 00A8 }
_0xA:
