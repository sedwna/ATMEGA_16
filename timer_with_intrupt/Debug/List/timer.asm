...
; 0000 0084 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (1<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(4)
	OUT  0x39,R30
; 0000 0085 
...
; 0000 00B7       {
; 0000 00B8 
; 0000 00B9    sprintf(str_minuteg,"%d",minuteg);
	LDI  R30,LOW(_str_minuteg)
	LDI  R31,HIGH(_str_minuteg)
	CALL SUBOPT_0x0
	MOVW R30,R4
	CALL SUBOPT_0x1
; 0000 00BA       lcd_gotoxy(0,0);
	LDI  R30,LOW(0)
	CALL SUBOPT_0x2
; 0000 00BB       lcd_puts(str_minuteg);
	LDI  R26,LOW(_str_minuteg)
	LDI  R27,HIGH(_str_minuteg)
	CALL _lcd_puts
; 0000 00BC 
; 0000 00BD       lcd_gotoxy(2,0);
	LDI  R30,LOW(2)
	CALL SUBOPT_0x2
; 0000 00BE       lcd_puts(":");
	__POINTW2MN _0x8,0
	CALL _lcd_puts
; 0000 00BF 
; 0000 00C0       sprintf(str_secendg,"%d",secendg);
	LDI  R30,LOW(_str_secendg)
	LDI  R31,HIGH(_str_secendg)
	CALL SUBOPT_0x0
	MOVW R30,R6
	CALL SUBOPT_0x1
; 0000 00C1       lcd_gotoxy(3,0);
	LDI  R30,LOW(3)
	CALL SUBOPT_0x2
; 0000 00C2       lcd_puts(str_secendg);
	LDI  R26,LOW(_str_secendg)
	LDI  R27,HIGH(_str_secendg)
	CALL _lcd_puts
; 0000 00C3 
; 0000 00C4 
; 0000 00C5 
